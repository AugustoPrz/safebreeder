...
export default function ScanPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold">
                      {active
                        ? t.scan.scannerActive
                        : t.scan.scannerInactive}
                    </div>
      ...
      {step === "done" && (
        <Card>
          <CardBody className="py-10 flex flex-col items-center text-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-2 pt-2">
              ...
              <Button onClick={() => router.push(`/lots/${lotId}/stock`)}>
                {t.scan.viewStock}
              </Button>
            </div>
          </CardBody>
...
function LugarStep({
  ...
  return (
    <Card>
      <div className="px-5 pt-4 pb-3 border-b border-border">
        <h2 className="font-semibold">{t.scan.pickPlaceTitle}</h2>
      </div>
      <CardBody className="space-y-4">
